class MovingCloudStorageFolder {
  init (config, env) {
  ...
  async run (event, context) {
    ...
    try {
      const info = await this.cloudstorage.provider(provider).moveFolder(remoteSourcePath, remoteTargetPath)
...
module.exports = MovingCloudStorageFolder
