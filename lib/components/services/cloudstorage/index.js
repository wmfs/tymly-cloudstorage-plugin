...
class CloudstorageService {
  ...
  async checkFolderPathExists (path) {
    return this.defaultProvider_.checkFolderPathExists(path)
  } // ensureFolderPath
  ...
  async moveFolderContents (sourcePath, targetPath) {
    return this.defaultProvider_.moveFolderContents(sourcePath, targetPath)
  }
