...
describe('Multiple providers registered', function () {
  ...
  describe('use default provider', () => {
    ...
    it('copyFileToRemotePath', async () => {
      ...
      expect(remoteName).to.eql('remote-first/local.test-first')
    })
    it('copyFileToRemotePath with filename', async () => {
      ...
      expect(remoteName).to.eql('remote-first/new.name-first')
    })
    it('copyFileToLocalPath', async () => {
      ...
      expect(localName).to.eql('local/remote.test-first-first')
    })
  })
  ...
  for (const [t, p, s] of providers) {
    describe(`request ${t} provider`, () => {
      ...
      it('copyFileToRemotePath', async () => {
        ...
        expect(remoteName).to.eql(`remote-${s}/local.file-${s}`)
      })
      it('copyFileToRemotePath with filename', async () => {
        ...
        expect(remoteName).to.eql(`remote-${s}/new.name-${s}`)
      })
      it('copyFileToLocalPath', async () => {
        ...
        expect(localName).to.eql(`local/thing.to.get-${s}-${s}`)
      })
    })
  } // for ...
